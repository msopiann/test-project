  ...
  return (
    <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24">
      <>
        ...
        <h2 className="mt-3 md:mt-2 text-lg font-medium tracking-tight sm:text-xl">
          Frontend Developer
        </h2>

        <p className="mt-3 md:mt-2 max-w-xs leading-normal">
          Loves to build responsive website.
        </p>

        <Link href="/" className="mt-4 md:mt-2 max-w-xs leading-normal">
          See my resume{" "}
